...
//    [<EntryPoint>]
//    let main args = 
//        use system = System.create "bittorrent-fsharp-system" (Configuration.load ())
//----------------------------------------------------------------------------------------------------------------------
//        let myMessageActorRef =
//            spawn system "bittorrent-fsharp-my-message-actor"
//                (fun mailbox ->
...
//            select "akka://bittorrent-fsharp-system/user/bittorrent-fsharp-my-message-actor" system
//                
